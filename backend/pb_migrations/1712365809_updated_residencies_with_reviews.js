...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("h4wzpbmx")

  // remove
  collection.schema.removeField("i5ru1xzz")

  // remove
  collection.schema.removeField("kk7znswh")

  // remove
  collection.schema.removeField("e0wxiobt")

  // remove
  collection.schema.removeField("qmjzphb3")
