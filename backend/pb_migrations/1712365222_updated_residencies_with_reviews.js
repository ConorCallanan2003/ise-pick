...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("qgrtc4os")

  // remove
  collection.schema.removeField("ptesaopi")

  // remove
  collection.schema.removeField("uncfawp5")

  // remove
  collection.schema.removeField("w9f0mytt")

  // remove
  collection.schema.removeField("elfa1jdo")
